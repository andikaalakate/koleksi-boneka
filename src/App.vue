...
<template>
  <div
    class="min-h-screen max-lg:bg-size-[100%] lg:bg-size-[40%] scrollbar-none p-6 flex flex-col items-center transition-colors duration-500 bg-repeat"
    :class="
      isDark
  ...
  >
    ...
    <!-- Credits -->
    <div
      class="flex items-center justify-center gap-4 text-sm mb-4 animate-fade-in"
    ...
    >
      ...
      <a
        href="https://facebook.com/andikaalakate"
        target="_blank"
        class="flex items-center gap-1 transition-all hover:scale-105"
